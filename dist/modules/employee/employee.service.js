...
const createEmployeeService = (employeeData) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        inspector_1.console.log("Employee data:", employeeData, error);
...
const updateEmployeePasswordService = (password, id) => __awaiter(void 0, void 0, void 0, function* () {
    const hashedPassword = yield bcryptjs_1.default.hash(password, variables_1.default.salt);
...
const updateEmployeeLanguage = (id, employeeLanguage) => __awaiter(void 0, void 0, void 0, function* () {
    // employeeLanguage = { employeeId, language, rtl }
    const result = yield employee_model_1.Employee.findOneAndUpdate({ id }, // ← استخدم الحقل الصحيح
    { employeeLanguage: employeeLanguage }, { new: true });
    return result;
});
// get employee language
const getEmployeeLanguage = (id) => __awaiter(void 0, void 0, void 0, function* () {
    inspector_1.console.log("getEmployeeLanguage called with id:", id);
